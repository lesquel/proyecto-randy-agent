...
const HistoryBlankStateIcon = () => (
  ...
  >
    ...
    {/* Main orange circle with pulse animation */}
    <motion.path
    ...
    {/* Clock elements with staggered animation */}
    <motion.g
      clipPath="url(#clip1_9008_17675)"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    <defs>
      <clipPath id="clip0_7378_12246">
        <rect width="16" height="16" fill="white" transform="translate(13.8438 47.6617) rotate(-8.33)" />
      </clipPath>
      <clipPath id="clip1_9008_17675">
...
const SessionBlankState = () => {
  ...
  return (
    <motion.div
      ...
      className="relative mt-2 flex items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-sm border border-border/30 pb-8 pt-6 shadow-sm"
    >
      ...
      <div className="relative flex flex-col items-center gap-4">
        ...
        >
          ...
          <motion.h3
            className="bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-base font-semibold text-transparent"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
              ...
              {typeof errorMessage === "string" ? (
                ...
                <span className="inline-flex flex-wrap items-center justify-center gap-1">
                  ...
                  <motion.span whileHover={{ scale: 1.05 }} className="inline-block">
                    <Link
                      className="font-medium text-primary underline decoration-primary/50 underline-offset-2 transition-all duration-200 hover:decoration-primary hover:text-primary/80"
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.4, delay: 1 }}
          className="mt-2 flex items-center gap-2 rounded-full bg-muted/50 px-3 py-1.5"
        >
          <div className="h-1.5 w-1.5 rounded-full bg-primary/60" />
          <span className="text-xs font-medium text-muted-foreground">
            {!agentId ? "Select an agent to get started" : "Start your first conversation"}
          </span>
        </motion.div>
      </div>
    </motion.div>
